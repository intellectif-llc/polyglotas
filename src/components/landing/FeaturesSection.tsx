      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-16">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            ...
            <button className="px-8 py-4 bg-brand-gradient hover:shadow-2xl hover:shadow-purple-500/25 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 border border-white/10 shadow-lg cursor-pointer">
