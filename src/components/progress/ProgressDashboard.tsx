...
import WordProgressChart from "./WordProgressChart";
...
const ProgressDashboard: React.FC = () => {
  ...
  const { tier, isStarterOrAbove } = useSubscriptionTier();
  ...
  const totalLessons =
    enhancedUnits?.reduce(
      (sum, unit) => sum + unit.progress.total_lessons,
      0
    ) || 0;
  const completedLessons =
    enhancedUnits?.reduce(
      (sum, unit) => sum + unit.progress.completed_lessons,
      0
    ) || 0;
      ...
      <div className="bg-white rounded-lg shadow-xl p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            title={showAllLevels ? "Show Relevant Only" : "Show All Levels"}
          >
              ...
              <div key={level}>
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="text-sm text-gray-600">
                    Progress for {tier} tier activities
                  </div>
                </div>
        ...
        {/* Progress Chart - Only for Paid Tiers */}
        <div className="mt-8">
          {isStarterOrAbove ? <WordProgressChart /> : <UpgradePrompt />}
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-600">
              Achievement tracking will be available soon. Keep learning to
