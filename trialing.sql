-- ========================================
-- STANDARD TRIALING FUNCTIONS
-- Handles 7-day Pro trials with Stripe payment method requirement
-- ========================================

-- Function to check if user is eligible for a standard trial
...
-- Function to create a standard trial subscription
CREATE OR REPLACE FUNCTION public.create_standard_trial(
...
-- Function to expire standard trials (separate from partnership trials)
...
-- Function to handle trial conversion to paid subscription
...
-- Function to get trial eligibility with detailed reason
...
RETURNS TABLE(
  ...
  previous_subscription_count integer
)
LANGUAGE plpgsql
AS $$
DECLARE
